...
import { AiOutlineUsergroupAdd, AiFillDollarCircle, AiOutlineUserSwitch } from "react-icons/ai";
...
const Navigation = () => {
    ...
    return (
        <div className={`navigation ${nav && "active"} ${darkTheme && "dark"}`}>
            ...
            <Nav title='Analytice' Icon={VscGraphLine} />
            ...
            <Nav title='Earnings' Icon={AiFillDollarCircle} />
